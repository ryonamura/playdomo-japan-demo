#!/usr/bin/env python3
"""Convert the DOMO Japan localization report from Markdown to styled HTML."""

import markdown

INPUT = "report_v3.md"
OUTPUT = "DOMO_日本市場進出_総合レポート_v3.html"
...
<title>DOMO 日本市場進出 総合レポート</title>
<style>{CSS}</style>
</head>
<body>
...
print("ブラウザで開いて Cmd+P → PDFとして保存 でPDF化できます")
